  ...
  return [
    {
      ...
      alt: _(
        msg`A collection of popular feeds you can find on K4M2A, including News, Booksky, Game Dev, Blacksky, and Fountain Pens`,
      ),
    },
    {
    ...
    },
    {
      ...
      description: _(
        msg`No ads, no invasive tracking, no engagement traps. K4M2A respects your time and attention.`,
      ),
      alt: _(
        msg`An illustration of several K4M2A posts alongside repost, like, and comment icons`,
      ),
    },
  ][step]
}
