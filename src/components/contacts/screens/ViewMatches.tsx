      ...
      case 'no matches header':
        return (
          <Header
            ...
            subtitleText={
              <Trans>
                K4M2A is more fun with friends. Do you want to invite some of
                yours?{' '}
                <InviteInfo
    ...
    <View style={[gutter, a.py_md, a.border_t, t.atoms.border_contrast_low]}>
      <ProfileCard.Header>
        ...
        {phoneNumber && currentAccount && (
          <Button
            label={_(msg`Invite ${name} to join K4M2A`)}
            color="secondary"
            size="small"
            onPress={async () => {
              ...
              try {
                await SMS.sendSMSAsync(
                  [phoneNumber],
                  _(
                    msg`I'm on K4M2A as ${currentAccount.handle} - come find me! https://bsky.app/download`,
                  ),
                )
              } catch (err) {
