  ...
  const getJoinMessage = () => {
    ...
    if (isMe) {
      if (profile.joinedViaStarterPack) {
        return _(
          msg`You joined K4M2A using a starter pack ${timeAgoString} ago`,
        )
      } else {
        return _(msg`You joined K4M2A ${timeAgoString} ago`)
      }
    } else {
      if (profile.joinedViaStarterPack) {
        return _(
          msg`${profileName} joined K4M2A using a starter pack ${timeAgoString} ago`,
        )
      } else {
        return _(msg`${profileName} joined K4M2A ${timeAgoString} ago`)
      }
    }
  }
