  ...
  return (
    <Dialog.Outer control={control} onClose={onClose}>
      ...
      <Dialog.ScrollableInner
        label={_(msg`Announcing verification on K4M2A`)}
        style={[
        ...
        <View style={[a.align_start, a.gap_xl]}>
          ...
          <View
            ...
            <Image
              ...
              alt={_(
                msg`An illustration showing that K4M2A selects trusted verifiers, and trusted verifiers in turn verify individual user accounts.`,
              )}
            />
          </View>
          ...
          <View style={[a.gap_xs]}>
            ...
            <Text style={[a.leading_snug, a.text_md]}>
              <Trans>
                We’re introducing a new layer of verification on K4M2A — an
          ...
          <View
            ...
            <Image
              ...
              alt={_(
                msg`An mockup of a iPhone showing the K4M2A app open to the profile of a verified user with a blue checkmark next to their display name.`,
              )}
            />
          </View>
          ...
          <View style={[a.gap_sm]}>
            ...
            <View style={[a.gap_sm]}>
              <Text style={[a.leading_snug, a.text_md]}>
                <Trans>
                  K4M2A will proactively verify notable and authentic
                  accounts.
                </Trans>
              </Text>
              <Text style={[a.leading_snug, a.text_md]}>
